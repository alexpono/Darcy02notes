...
% \begin{figure}
%   \centerline\includegraphics[height=8cm]{figures/elasticBeadsStack_VolumicFraction.png}
...
\begin{figure}
  \centerline{\includegraphics[height=8cm]{figures/beadsStack.png}} % [width=0.5\textwidth]
  \caption{beads}
  \label{fig:beads}
\end{figure}
...
\begin{figure}
  \centerline{\includegraphics[width=0.5\textwidth]{figures/beadsProps_setup.jpg}}% Images in 100% size
  \caption{Set up for pressing the beads.}
\label{fig:beadsPress_setup} 
\end{figure}

\begin{figure}
  \centerline{\includegraphics[width=0.6\textwidth]{figures/beadsProps_press01.png}}% Images in 100% size
